...
if __name__ == '__main__':
	...
	doctor_url = input("Enter the url for a doctor's ZocDoc: ") # 'https://www.zocdoc.com/doctor/irina-lelchuk-do-66023?LocIdent=57389&reason_visit=75&insuranceCarrier=-1&insurancePlan=-1'
